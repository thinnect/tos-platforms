...
void appHalInit(void)
{
  ...
  //GPIO_PinModeSet(3, 10, gpioModeInputPull, 0);
  ...
  //GPIOINT_CallbackRegister(10, inputCb);
  ...
  //GPIO_IntConfig(3, 10, true, false, true);
}
